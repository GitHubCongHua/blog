...
<div class="header">
                    ...
                    <table class="table">
                        ...
                        @foreach($blog as $blogs)
                            <tr>
                                ...
                                <td><b>{{$blogs->updated_at}}</b></td>
                                <td><form action="{{url('update_view')}}" method="post">
                                            {!! csrf_field()!!}<input type="submit" value="update" >
                                            <input type="hidden" value="{{$blogs->id}}" name="id">
                                            <input type="hidden" value="{{$blogs->unique_id}}" name="unique_id"></form>
                                <form action="{{url('delete')}}" method="post" style="float:left">
                                            {!! csrf_field()!!}<input type="submit" value="delete" >
                                            <input type="hidden" value="{{$blogs->id}}" name="id">
                                            <input type="hidden" value="{{$blogs->unique_id}}" name="unique_id"></form></td>
    ...
    <div class="top-right links">
        @if (Auth::check())
            <a href="{{ url('scan_view') }}">Scan Blog</a>
